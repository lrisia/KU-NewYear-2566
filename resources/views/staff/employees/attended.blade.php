...
<section class=" @if ($employees->count() <= 3) min-h-screen @endif">
  <div class="mx-10 justify-center" >
    <form action="{{ route('staff.attended') }}" method="get" class="my-10">
        <label for="search" class="md:text-lg">ค้นหาชื่อผู้เข้าร่วมงาน</label>
        <div class="relative">
    ...
    <div class="relative flex items-end justify-end ml-8 mt-2">
        <a href="/staff/qr-code/scan" class="absolute p-2 text-white text-sm mobile:text-xs shadow rounded-lg bg-[#B0C03B] hover:bg-[#98a534]">
