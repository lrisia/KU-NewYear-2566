                    ...
                    <table class="w-full text-left mr-0">
                        <thead class="bg-[#e7e6e6] border-2 text-sm mobile:text-xs sm:text-base">
                            <tr>
                                ...
                                <th scope="col" class="hidden print:table-cell print:visible print:py-3 print:px-2 print:border-r"><p class="invisible print:visible text-center">เลขบัตรประชาชน</p></th>
                                <th scope="col" class="hidden print:table-cell print:visible print:py-3 print:px-2 "><p class="invisible print:visible text-center">เซ็นชื่อ</p></th>
                            </tr>
                        </thead>
                        <tbody class="m-2">
                            @foreach($employees as $employee)
                            <tr class="border border-r-2 text-gray-700 text-sm mobile:text-xs sm:text-base">
                                <td class="p-2 sm:px-6 print:py-7 print:border-r print:w-1/12">{{ $loop->iteration }}</td>
                                ...
                                <td class="px-2 py-4 print:px-1 print:text-center print:border-r print:w-1/12"></td>
