...
<section>
  <div class="mx-10 justify-center">
    <form action="{{ route('employees.search-registrant') }}" method="get" class="my-10">
        ...
        <div class="relative">
            ...
            <input type="search" name="keyword" id="keyword" class="block w-full p-3 px-10 mt-3 text-gray-700 shadow border border-[#e5e5e5] rounded-lg bg-[#f2f0f0] focus:ring-blue-500 focus:border-blue-500 md:py-4" placeholder="" required>
