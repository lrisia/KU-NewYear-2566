<template>
    <div class="mx-8 min-h-screen">
        ...
        <div id="info" class="hidden max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-md mx-auto mt-8">
            ...
            <a @click="storeAttend" class="inline-flex items-center text-white shadow rounded-lg bg-[#B0C03B] hover:bg-[#98a534] px-8 py-2 text-center focus:ring-4 focus:outline-none focus:ring-blue-300">
                เข้าร่วมงาน
