            ...
            <div class="modal-wrapper flex items-center z-30">
                <div class="modal max-w-md mx-auto xl:max-w-5xl lg:max-w-5xl md:max-w-2xl bg-white max-h-screen shadow-lg flex-row rounded relative">
                    <div class="modal-header flex p-4 rounded-t border-b border-gray-200 bg-[#F2F2F2] shadow">
                        ...
                        <button @click="onToggle" type="button" class="text-gray-600 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="defaultModal">
                    ...
                    <div class="modal-body p-5 w-full h-full overflow-y-auto ">
                        ...
                        <p class="text-base my-4 leading-relaxed text-gray-500 dark:text-gray-400">
                            เข้าร่วม / ไม่เข้าร่วมงาน <span v-if="this.error === 'answer'" class="ml-3 text-red-500">กรุณาเลือกคำตอบ</span>
                        </p>
                        <ul class="flex max-w-md">
                            <li class="relative mr-4">
                                ...
                                <label class="py-2 px-7 flex justify-center bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-green-500 peer-checked:ring-2 peer-checked:border-transparent peer-checked:shadow-lg peer-checked:pr-10" for="answer_yes">
                                    เข้าร่วมงาน
                                </label>
                            ...
                            <li class="relative">
                                ...
                                <label class="py-2 px-6 flex justify-center bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent peer-checked:shadow-lg peer-checked:pr-10" for="answer_no">
                                    ไม่เข้าร่วมงาน
                                </label>
                        ...
                        <div id="email_container" class="hidden mt-6">
                            ...
                            <input v-model="data.email" type="email" name="email" id="email" class="pl-2 bg-gray-50 border border-gray-300 rounded-lg py-1" placeholder="example@ku.th">
                            <p v-if="this.error === 'email_1'" class="text-red-500 mt-2">กรุณากรอกอีเมล</p>
                            <p v-if="this.error === 'email_2'" class="text-red-500 mt-2">อีเมลนี้ถูกใช้ไปแล้ว</p>
                        </div>
                    </div>
                    <div class="modal-footer mb-4 px-5">
                        <div class="flex items-center justify-center space-x-2 rounded-b">
                            <button @click="onToggle" class="text-gray-500 mr-2 bg-gray-50 hover:bg-gray-200 shadow rounded-lg border border-[#DADADA] px-6 py-2">ยกเลิก</button>
                            <button @click="submitForm" type="button" class="text-white shadow rounded-lg bg-[#B0C03B] hover:bg-[#98a534] px-8 py-2">ตกลง</button>
                        </div>
                    </div>
                </div>
            </div>
